# for przyklad in range(2,31):
#
#
#     for dzielnik in range(2, przyklad):
#         if przyklad % dzielnik == 0:
#
#             print("%2d nie jest numerem pierwszym - dzielnik to %2d" % (przyklad,dzielnik ))
#             break
#     else:
#         print("%2d jest liczba pierwsza" % (przyklad))
...
text = 'Mechanical advantage is a measure of the force amplification achieved by using a tool, mechanical device or machine system. ' \
       ...
       'The model for this is the law of the lever. Machine components designed to manage forces and movement in this way are called mechanisms.[1] ' \
       'An ideal mechanism transmits power without adding to or subtracting from it. This means the ideal mechanism does ' \
       'not include a power source, is frictionless, and is constructed from rigid bodies that do not deflect or wear. ' \
